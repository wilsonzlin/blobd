...
impl BlobdProvider for Kv {
  ...
  fn metrics(&self) -> Vec<(&'static str, u64)> {
    ...
    vec![
      ...
      ("log_buffer_flush_leq_4k_count", metrics.log_buffer_flush_leq_4k_count()),
      ("log_buffer_flush_leq_64k_count", metrics.log_buffer_flush_leq_64k_count()),
      ("log_buffer_flush_leq_1m_count", metrics.log_buffer_flush_leq_1m_count()),
      ("log_buffer_flush_leq_8m_count", metrics.log_buffer_flush_leq_8m_count()),
